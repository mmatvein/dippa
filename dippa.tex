...
This end result is then plugged into Unity's Camera projection matrix, but in order to get the correct end result we disable Unity's automatic camera modelview matrix updating and replace it with our own. 
