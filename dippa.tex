...
Together, these four factors form virtual reality as defined by Sherman and Craig. They collect the requirements into definition \ref{definition:vr}.

\item[Virtual Reality] \label{definition:vr}
a medium composed of interactive computer simulations that sense the participant's position and actions and replace or augment the feedback to one or more senses, giving the feeling of being mentally immersed or present in the simulation (a virtual world). \cite{Sherman:2002:UVR:581839}
