...
Originally in 2010, when the Kinect was first launched, the system was proprietary. This changed quickly however, as hackers started reverse engineering the system in order to gain access to the technology. Within just a couple of days, the greater public gained access to some of Kinect's features and started creating applications to showcase the functionality. \cite{
