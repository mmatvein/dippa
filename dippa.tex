...
Akenine-Möller et al. \cite{RTR3} define the basic perspective projection matrix P_{p}, where n, f, t, b, r and l are the near, far, top, bottom, right and left planes, respectively.
