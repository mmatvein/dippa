...
% ------------------------------------------------------------------
\newcommand{\TITLE}{The Design and Implementation of a VR Toolkit}
\newcommand{\FTITLE}{}
\newcommand{\STITLE}{}
\newcommand{\SUBTITLE}{}
\newcommand{\FSUBTITLE}{}
...
\newcommand{\SUPERVISOR}{Assistant Professor Perttu Hämäläinen}
\newcommand{\FSUPERVISOR}{Apulaisprofessori Perttu Hämäläinen}
...
\newcommand{\COVERSUPERVISOR}{Assistant Professor Perttu Hämäläinen, Aalto University}
...
The two main tasks RUIS handles are input and display configuration management. The challenges involved in the management of input methods are for example the calibraton of coordinate systems, providing a clean interface for the usage of different types of devices in a standarized way and providing prebuilt modules that handle common VR tasks such as head tracking. The multitude of different virtual reality display configurations on the other hand require solutions for multi-display environments, head tracked views, projector keystoning correction and stereoscopic displays. RUIS implements these features and gives the developer a chance to create motion-based 3D applications inside the Unity Editor. 

Special attention during the development was also given to the usability of RUIS - especially the idiomatic usage of Unity3D. The intent of RUIS is to This thesis explains the design decisions and implemention details that arose in the development of RUIS.}
